...
import 'package:penasaranfix/app/modules/webinar/model/webinar_list.dart';
      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 600) {
            return CardWebinar(gridCount: 1);
          } else if (constraints.maxWidth <= 1200) {
            return CardWebinar(gridCount: 2);
          } else {
            return CardWebinar(gridCount: 3);
          }
        },
      ),
    );
...
class CardWebinar extends StatelessWidget {
  final int gridCount;
  const CardWebinar({Key? key, required this.gridCount}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.count(
          ...
          children: webinarList.map((webinar) {
              ...
              InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(webinar.imageAsset, height: 150),
                      Padding(
