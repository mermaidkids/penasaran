...
import '../model/beasiswa_list.dart';
...
class BeasiswaView extends GetView<BeasiswaController> {
  const BeasiswaView({Key? key}) : super(key: key);
      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 600) {
            return CardBeasiswa(gridCount: 1);
          } else if (constraints.maxWidth <= 1200) {
            return CardBeasiswa(gridCount: 2);
          } else {
            return CardBeasiswa(gridCount: 3);
          }
        },
      ),
    );
...
class CardBeasiswa extends StatelessWidget {
  final int gridCount;
  const CardBeasiswa({Key? key, required this.gridCount}) : super(key: key);
              ...
              InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(beasiswa.imageAsset, height: 150),
                      Padding(
