...
import 'package:penasaranfix/app/modules/detail/model/detail_list.dart';
      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 600) {
            return CardDetail(gridCount: 1);
          } else if (constraints.maxWidth <= 1200) {
            return CardDetail(gridCount: 2);
          } else {
            return CardDetail(gridCount: 3);
          }
        },
      ),
    );
...
class CardDetail extends StatelessWidget {
  final int gridCount;
  const CardDetail({Key? key, required this.gridCount}) : super(key: key);
              ...
              InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(detail.imageAsset, height: 150),
                      Padding(
