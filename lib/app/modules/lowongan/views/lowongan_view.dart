...
import '../model/lowongan_list.dart';
...
class LowonganView extends GetView<LowonganController> {
  const LowonganView({Key? key}) : super(key: key);
      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 600) {
            return CardLowongan(gridCount: 1);
          } else if (constraints.maxWidth <= 1200) {
            return CardLowongan(gridCount: 2);
          } else {
            return CardLowongan(gridCount: 3);
          }
        },
      ),
    );
...
class CardLowongan extends StatelessWidget {
  final int gridCount;
  const CardLowongan({Key? key, required this.gridCount}) : super(key: key);
              ...
              InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset(lowongan.imageAsset, height: 150),
                      Padding(
